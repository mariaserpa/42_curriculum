...
/*   Updated: 2025/11/23 21:09:36 by mrabelo-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void PmergeMe::pairAndGroupVector(const std::vector<int>& vec, int left, int right, std::vector<int>& larger, 
...
void PmergeMe::mergeInsertSortVector(std::vector<int>& vec, int left, int right, int& comparisons)
{
	...
	// Phase 1: build pairs
	pairAndGroupVector(vec, left, right, larger, smaller, straggler, comparisons);
